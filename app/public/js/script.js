function createQuestions() {
	let q1 = "I easily get sad.";
	let q2 = "I Enjoy Rainey Days.";
	let q3 = "I am dependable and self-disciplined.";
	let q4 = "I love meeting new people.";
	let q5 = "I enjoy traveling and experiencing new things.";
	let q6 = "I can often sympathize with others.";
	let q7 = "I try to enjoy my days.";
	let q8 = "I living my best life.";
	let q9 = "I often get so lost in my thoughts.";
	let q10 = "I try to stay relaxed majority of my days.";
...
var config = {
	...
	".chosen-select-no-results": {
		no_results_text: "nothing is found!"
	},
	".chosen-select-width": {
		width: "95%"
	}
